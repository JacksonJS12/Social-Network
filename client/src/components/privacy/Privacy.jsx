      ...
      <div className="container">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Cat Blog.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Cat Blog, accessible from{" "}
             HERE
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://www.yourcat.co.uk/the-your-cat-blog/policy"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.yourcat.co.uk/the-your-cat-blog/policy
            </a>
          </li>
        </ul>
      </div>
